...
@endsection
@section('content')
	<form class="form" id="form" action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
		{{ method_field('POST') }}
		{{ csrf_field() }}
		<fieldset>
			<div class="widget">
				...
				<div class="tab_container">
				    <div id='tab1' class="tab_content pd0">
				        <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="name" id="param_name" _autocheck="true" type="text" value="{{ old('name') }}" />
								</span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="slug" id="param_name" _autocheck="true" type="text" value="{{ old('slug') }}" />
								</span>
								<span name="name_autocheck" class="autocheck"></span>
							</div>
							<div class="clear"></div>
				         ...
				         <div class="formRow">
							...
							<div class="formRight">
								...
								<span class="one">
									<input type="checkbox" name="type_id[]" id="type_id" _autocheck="true" value="{{ $type->id }}" /> {{ $type->name }}
								</span>
								@endforeach
							</div>
							<div class="clear"></div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="price"  style='width:100px' id="param_price" class="format_number" _autocheck="true" type="number" value="{{ old('price') }}" />
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span>
									<input name="sale"  style='width:100px' id="param_discount" class="format_number"  type="number" value="{{ old('sale') }}" />
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="color"  style='width:90%' id="param_price" _autocheck="true" type="text" placeholder="Thêm ',' cho việc nhập nhiều màu sắc. Ex: Trắng, đen, ..." value="{{ old('color') }}" />
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="size"  style='width:90%' id="param_price" _autocheck="true" type="text" placeholder="Thêm ',' cho việc nhập nhiều kích cỡ. Ex: Lớn, nhỏ, ..." value="{{ old('size') }}" />
							...
							<div class="formRight">
								<select name="category_id" _autocheck="true" id='param_cat' class="left">
									...
									@foreach( $categories as $category )
									    <option value="{{ $category->id }}">{!! $category->paddedName() !!}</option>
									@endforeach
								</select>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="desc" id="param_sale" rows="4" cols="">{{ old('desc') }}</textarea></span>
					 	...
					 	<div class="formRow">
							...
							<div class="formRight">
								<span class="formLeft">
									<input type="radio" name="slide" id="hidden" checked="checked" value="0"> Không chọn
								</span>
								<span class="formRight">
									<input type="radio" name="slide" id="hidden" value="1"> Chọn làm slide
								</span>
							</div>
							<div class="clear"></div>
						</div>
					...
					<div id='tab3' class="tab_content pd0" >
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="meta_key" id="param_meta_key" _autocheck="true" rows="4" cols="">{{ old('meta_key') }}</textarea></span>
