...
@endsection
@section('content')
	<form class="form" id="form" action="{{ route('admin.types.store') }}" method="post" enctype="multipart/form-data">
				     ...
				     <div id='tab1' class="tab_content pd0">
						...
						<div class="formRow">
					 	...
					 	<div class="formRow">
							...
							<div class="formRight">
								<span class="formLeft">
									<input type="radio" name="display" id="hidden" checked="checked" value="0"> Ẩn
								</span>
								<span class="formRight">
									<input type="radio" name="display" id="hidden" value="1"> Hiện
								</span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="sort"  style='width:100px' id="sort" _autocheck="true" type="number" value="{{ old('sort') }}" />
								</span>
