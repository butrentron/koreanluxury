				...
				<div class="tab_container">
				     <div id='tab1' class="tab_content pd0">
				         <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="name" id="name" _autocheck="true" type="text" placeholder="Tiêu đề cho danh mục sản phẩm" value="{{ old('name') }}" />
								</span>
				         ...
				         <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="slug" id="slug" _autocheck="true" type="text" placeholder="Đường dẫn URL của danh mục sản phẩm. Sẽ được lấy mặc định theo tên nếu như bị trống." />
								</span>
								<span name="name_autocheck" class="autocheck"></span>
							</div>
							<div class="clear"></div>
				        ...
				        <div class="formRow">
							...
							<div class="formRight">
								<select name="order">
									...
									<option value="childOf">Làm danh mục con</option>
								</select>
								<select name="orderCategory">
									<option value=""></option>
									@foreach($orderCategories as $orderCategory)
									<option value="{{ $orderCategory->id }}">{{ $orderCategory->name }}</option>
									@endforeach
								</select>
