...
@endsection
@section('content')
	<form class="form" id="form" action="{{ route('admin.pages.store') }}" method="post" enctype="multipart/form-data">
				...
				<div class="tab_container">
				     <div id='tab1' class="tab_content pd0">
				         <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="name" id="name" _autocheck="true" type="text" placeholder="Tiêu đề cho trang" value="{{ old('name') }}" />
								</span>
				         ...
				         <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="uri" id="uri" _autocheck="true" type="text" placeholder="Đường dẫn URL của trang. Ex: /contact or /lien-he" value="{{ old('uri') }}" />
								</span>
								<span name="name_autocheck" class="autocheck"></span>
								@if($errors->has('uri'))
								<div name="name_error" class="clear error">
					 ...
					 <div id='tab2' class="tab_content pd0" >
						...
						<div class="formRight">
							<span class="oneTwo"><textarea name="set_title" id="param_site_title" _autocheck="true" rows="4" cols=""></textarea></span>
						...
						<div class="formRight">
							<span class="oneTwo">
								<textarea name="meta_key" id="param_meta_key" _autocheck="true" rows="4" cols=""></textarea>
							</span>
