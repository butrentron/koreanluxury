...
@section('head.title')
<title>{!! $category && $category->set_title ? $category->set_title : $category->name !!}</title>
@stop

@section('meta')
	<meta name="keywords" content="{!! $category && $category->meta_key ? $category->meta_key : $category->name !!}">
	<meta name="description" content="{!! $category && $category->meta_desc? $category->meta_desc : $category->desc ? $category->desc : $category->description !!}">
@stop
